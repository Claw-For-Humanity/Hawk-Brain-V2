...
def metric3d_vit_giant2(pretrain=False, **kwargs):
  ...
  print('importing process entered')
  ...
  print('metric3d vit giant 2 imported')
...
if __name__ == '__main__':
  ...
  rgb = rgb[None, :, :, :]
  print('defining process done\n')


  ###################### canonical camera space ######################
  # inference
  print('\ninference begins - detailed analysis begins\n')
  
  print('\nmodel loading begins')
  model = torch.hub.load('yvanyin/metric3d', 'metric3d_vit_giant2', pretrain=False)
  print('model loaded\n')
  print('\nskipping cuda evaluation\n')
  # model.cuda().eval()

  print('\ntorch inference begins')
  with torch.no_grad():
