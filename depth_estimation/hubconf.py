...
def metric3d_vit_giant2(pretrain=False, **kwargs):
  ...
  '''
  print('entered vit giant 2 function')
  ...
  if pretrain:
    model.load_state_dict(
      torch.load('/home/erickdhdock/Desktop/ClawForHumanity/Metric3D-main/assets/metric_depth_vit_giant2_800k.pth'), 
      strict=False,
    )
  return model
...
if __name__ == '__main__':
  ...
  # inference
  model = torch.hub.load('yvanyin/metric3d', 'metric3d_vit_giant2', pretrain=False)
  model.load_state_dict(torch.load('/home/erickdhdock/Desktop/ClawForHumanity/Metric3D-main/assets/metric_depth_vit_giant2_800k.pth'), strict=False)
