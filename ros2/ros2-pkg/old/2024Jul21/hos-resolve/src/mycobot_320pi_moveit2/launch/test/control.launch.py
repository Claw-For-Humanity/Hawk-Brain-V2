...
def generate_launch_description():
  ...
  default_robot_name = 'mycobot_320pi' # ?? (figure it out?)
  gazebo_launch_file_path = 'launch' # ??
  gazebo_models_path = 'models' # ??
  ros_gz_bridge_config_file_path = 'config/ros_gz_bridge.yaml' # under mycobot_320pi_moveit2/config
  rviz_config_file_path = 'config/moveit.rviz' # under mycobot_320pi_moveit2/config
  urdf_file_path = 'urdf/mycobot_320_pi_2022/mycobot_320_pi_moveit_2022_gz.urdf.xacro' # under mycobot_description/urdf
  world_file_path = 'worlds/empty.world' # e.g. 'worlds/empty.world', 'worlds/house.world'
 
  # Set the path to different files and folders.
  pkg_ros_gz_sim = FindPackageShare(package='ros_gz_sim').find('ros_gz_sim') # ext pkg 
  ...
  default_ros_gz_bridge_config_file_path = os.path.join(pkg_share_mycobot, ros_gz_bridge_config_file_path) # under mycobot
  ...
  # Start Gazebo server *** edited- world-> 'empty.sdf' ***
  ...
  # Launch RViz - given (seems to work better)
  start_rviz_cmd = Node(
  ...
  #           PythonLaunchDescriptionSource(
  #               str(f"{pkg_share_mycobot}/launch/moveit_rviz.launch.py")
  #           ),
  ...
  # Spawn the robot - gazebo & rviz (seems)
  ...
  # ld.add_action(start_gazebo_cmd) # TODO: seperate thingy
  ld.add_action(start_gazebo_server_cmd)
  ld.add_action(start_gazebo_client_cmd)
  ld.add_action(start_robot_state_publisher_cmd)
  ld.add_action(start_rviz_cmd)
  # ld.add_action(start_tf_publish)
