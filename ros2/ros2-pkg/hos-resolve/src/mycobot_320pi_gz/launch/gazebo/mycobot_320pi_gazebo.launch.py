...
##################################### LAUNCH ARGs ##################################### 
  ...
  # from here is for launch_move_group FIXME
...
##################################### ACTION ##################################### 
  ...
  # IMPORTANT: make sure to input robot description or it will fail to read.
  ...
  # orig: joint_state -> arm_controller -> gripper_controller
